...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/janek/Magisterka/Intelligent-Vibroacoustic-Machine-Diagnostic-System-on-FPGA/Hilbert_with_fft/Hilbert_and_fft_test/Hilbert_and_fft_test.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
