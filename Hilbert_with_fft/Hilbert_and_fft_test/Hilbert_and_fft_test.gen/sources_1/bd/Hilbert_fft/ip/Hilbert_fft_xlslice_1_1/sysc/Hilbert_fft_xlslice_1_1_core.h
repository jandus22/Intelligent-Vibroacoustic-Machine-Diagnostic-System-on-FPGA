...
#ifndef _Hilbert_fft_xlslice_1_1_core_h_
#define _Hilbert_fft_xlslice_1_1_core_h_

#include <systemc.h>
#include "properties.h"


class Hilbert_fft_xlslice_1_1_core : public sc_module 
{
    public: 
       Hilbert_fft_xlslice_1_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(Hilbert_fft_xlslice_1_1_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~Hilbert_fft_xlslice_1_1_core() = default;
