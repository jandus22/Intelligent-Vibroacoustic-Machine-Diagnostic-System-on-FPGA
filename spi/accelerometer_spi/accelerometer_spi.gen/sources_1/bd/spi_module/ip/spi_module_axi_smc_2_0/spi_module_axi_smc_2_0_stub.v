...
// Command     : write_verilog -force -mode synth_stub -rename_top spi_module_axi_smc_2_0 -prefix
//               spi_module_axi_smc_2_0_ spi_module_axi_smc_2_0_stub.v
...
(* CHECK_LICENSE_TYPE = "spi_module_axi_smc_2_0,bd_fa6d,{}" *) (* CORE_GENERATION_INFO = "spi_module_axi_smc_2_0,bd_fa6d,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_fa6d,Vivado 2025.2" *) 
module spi_module_axi_smc_2_0(aclk, aresetn, S00_AXI_awaddr, S00_AXI_awlen, 
