...
//--------------------------------------------------------------------------------
//Command: generate_target bd_fa6d.bd
//Design : bd_fa6d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_fa6d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_fa6d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=4,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "spi_module_axi_smc_2_0.hwdef" *) 
module bd_fa6d
   (M00_AXI_awaddr,
    M00_AXI_awburst,
    M00_AXI_awcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI, ASSOCIATED_CLKEN s_sc_aclken, CLK_DOMAIN spi_module_zynq_ultra_ps_e_0_0_pl_clk0, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  ...
  m00_exit_pipeline_imp_JUGTI5 m00_exit_pipeline
       (.aclk(m_sc_clk_1),
  ...
  s00_entry_pipeline_imp_1IKM2QM s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_1M0KEH0 s00_nodes
...
module m00_exit_pipeline_imp_JUGTI5
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awburst,
...
module s00_entry_pipeline_imp_1IKM2QM
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_fa6d_s00mmu_0 s00_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_fa6d_s00sic_0 s00_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_awaddr(m_axi_awaddr),
        .m_axi_awcache(m_axi_awcache),
  ...
  bd_fa6d_s00tr_0 s00_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
