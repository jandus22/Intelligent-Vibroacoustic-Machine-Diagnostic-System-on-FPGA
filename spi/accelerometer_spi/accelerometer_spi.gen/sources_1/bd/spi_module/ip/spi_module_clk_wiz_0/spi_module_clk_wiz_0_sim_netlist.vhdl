...
--               /home/janek/Magisterka/Intelligent-Vibroacoustic-Machine-Diagnostic-System-on-FPGA/spi/accelerometer_spi/accelerometer_spi.gen/sources_1/bd/spi_module/ip/spi_module_clk_wiz_0/spi_module_clk_wiz_0_sim_netlist.vhdl
...
entity spi_module_clk_wiz_0_clk_wiz is
  port (
...
end spi_module_clk_wiz_0_clk_wiz;

architecture STRUCTURE of spi_module_clk_wiz_0_clk_wiz is
  signal clk_in1_spi_module_clk_wiz_0 : STD_LOGIC;
  signal clk_out1_spi_module_clk_wiz_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_spi_module_clk_wiz_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_spi_module_clk_wiz_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_spi_module_clk_wiz_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_spi_module_clk_wiz_0,
...
entity spi_module_clk_wiz_0 is
  ...
  attribute NotValidForBitStream of spi_module_clk_wiz_0 : entity is true;
end spi_module_clk_wiz_0;

architecture STRUCTURE of spi_module_clk_wiz_0 is
begin
inst: entity work.spi_module_clk_wiz_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
