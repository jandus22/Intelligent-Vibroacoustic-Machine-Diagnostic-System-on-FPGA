...
#
# Script generated by Vivado on Tue Aug 04 09:23:43 CEST 2026
# SW Build 6299465 on Fri Nov 14 12:34:56 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_spi_debug.sh
...
#
# Usage        : ila_spi_debug.sh
#                ila_spi_debug.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_spi_debug.sh [-rerun]
#                ila_spi_debug.sh [-reset_run]
#                ila_spi_debug.sh [-clean]
#                ila_spi_debug.sh [-reset_log]
#                ila_spi_debug.sh [-help]
#
...
#                script (type 'ila_spi_debug.sh -help' for more information).
#
...
# script info
echo -e "ila_spi_debug.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_spi_debug.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../spi_accelerometer_true.gen/sources_1/ip/ila_spi_debug/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../Xilinx/2025.2/data/rsb/busdef" +incdir+"../../../../spi_accelerometer_true.gen/sources_1/ip/ila_spi_debug/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ila_spi_debug xil_defaultlib.glbl -o ila_spi_debug_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ila_spi_debug_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kuszman/Magisterka/Intelligent-Vibroacoustic-Machine-Diagnostic-System-on-FPGA/spi/spi_true/spi_accelerometer_true/spi_accelerometer_true.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ila_spi_debug_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ila_spi_debug_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_spi_debug.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_spi_debug.sh [-help]\n\
Usage: ila_spi_debug.sh [-step]\n\
Usage: ila_spi_debug.sh [-lib_map_path]\n\
Usage: ila_spi_debug.sh [-rerun]\n\
Usage: ila_spi_debug.sh [-reset_run]\n\
Usage: ila_spi_debug.sh [-clean]\n\
Usage: ila_spi_debug.sh [-reset_log]\n\
Usage: ila_spi_debug.sh [-keep_index]\n\
Usage: ila_spi_debug.sh [-noclean_files]\n\n\
