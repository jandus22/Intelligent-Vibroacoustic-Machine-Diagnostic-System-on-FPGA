...
module dma_system
   (sensor_axis_aclk,
    ...
    sensor_axis_tready,
    sensor_axis_tvalid);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SENSOR_AXIS_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SENSOR_AXIS_ACLK, ASSOCIATED_BUSIF sensor_axis, ASSOCIATED_RESET sensor_axis_aresetn, CLK_DOMAIN dma_system_s_axis_aclk_0, FREQ_HZ 25000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sensor_axis_aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.SENSOR_AXIS_ARESETN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.SENSOR_AXIS_ARESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input sensor_axis_aresetn;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 sensor_axis TDATA" *) (* X_INTERFACE_MODE = "Slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME sensor_axis, CLK_DOMAIN dma_system_s_axis_aclk_0, FREQ_HZ 25000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.0, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [15:0]sensor_axis_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 sensor_axis TKEEP" *) input [1:0]sensor_axis_tkeep;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 sensor_axis TLAST" *) input sensor_axis_tlast;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 sensor_axis TREADY" *) output sensor_axis_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 sensor_axis TVALID" *) input sensor_axis_tvalid;
  ...
  dma_system_axi_dma_0_0 axi_dma_0
       (.axi_resetn(rst_ps8_0_99M_peripheral_aresetn),
        ...
        .s_axis_s2mm_tkeep(axis_clock_converter_0_M_AXIS_TKEEP),
  ...
  dma_system_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn));
  dma_system_axis_clock_converter_0_0 axis_clock_converter_0
       (.m_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s_axis_aclk(sensor_axis_aclk),
        .s_axis_aresetn(sensor_axis_aresetn),
        .s_axis_tdata(sensor_axis_tdata),
        .s_axis_tkeep(sensor_axis_tkeep),
  ...
  dma_system_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  dma_system_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
