...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B3F000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0xFFFFFFFFU, 0x00B3F000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18020C, 0x000010CCU ,0x00000044U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI2_OFFSET,
		0x000010CCU, 0x00000044U);
/*##################################################################### */
