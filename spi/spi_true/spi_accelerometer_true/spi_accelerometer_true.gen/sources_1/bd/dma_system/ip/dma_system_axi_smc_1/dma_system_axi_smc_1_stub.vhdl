...
-- Date        : Thu Aug  6 09:27:31 2026
-- Host        : Magisterka running 64-bit Ubuntu 26.04 LTS
-- Command     : write_vhdl -force -mode synth_stub -rename_top dma_system_axi_smc_1 -prefix
--               dma_system_axi_smc_1_ dma_system_axi_smc_1_stub.vhdl
-- Design      : dma_system_axi_smc_1
...
entity dma_system_axi_smc_1 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of dma_system_axi_smc_1 : entity is "dma_system_axi_smc_1,bd_0dac,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of dma_system_axi_smc_1 : entity is "dma_system_axi_smc_1,bd_0dac,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of dma_system_axi_smc_1 : entity is "yes";
end dma_system_axi_smc_1;

architecture stub of dma_system_axi_smc_1 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN dma_system_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_0dac,Vivado 2025.2";
begin
end;
