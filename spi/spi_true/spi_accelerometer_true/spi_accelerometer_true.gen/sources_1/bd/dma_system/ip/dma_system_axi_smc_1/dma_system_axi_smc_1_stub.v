...
// Date        : Thu Aug  6 09:27:30 2026
// Host        : Magisterka running 64-bit Ubuntu 26.04 LTS
// Command     : write_verilog -force -mode synth_stub -rename_top dma_system_axi_smc_1 -prefix
//               dma_system_axi_smc_1_ dma_system_axi_smc_1_stub.v
...
(* CHECK_LICENSE_TYPE = "dma_system_axi_smc_1,bd_0dac,{}" *) (* CORE_GENERATION_INFO = "dma_system_axi_smc_1,bd_0dac,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_0dac,Vivado 2025.2" *) 
module dma_system_axi_smc_1(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN dma_system_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken" *) input aclk /* synthesis syn_isclock = 1 */;
