...
HD_PWD='/home/kuszman/Magisterka/Intelligent-Vibroacoustic-Machine-Diagnostic-System-on-FPGA/ethernet/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ethernet_wrapper.tcl -notrace
